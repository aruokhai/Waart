...
class FunctionLocal {
  ...
  FunctionLocal({required this.typeCount, required this.valueType});
}
...
class Block {
  ...
  Block({required this.blockType, this.values});

  int resultCount() {
    return blockType == BlockType.Empty ? 0 : values!.length;
  }
}
